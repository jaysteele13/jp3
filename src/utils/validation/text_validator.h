...
class TextValidator {
public:
    static void displayScrollingText(Adafruit_SSD1306 &display, String text, int x, int y, int textSize, int clipLeft=0, int clipRight=128, int lineId = 0);
...
private:
    ...
    int charWidth,
    int clipLeft = 0,
    int clipRight = 128 // Screen Wdith
);
